"""Real baseline evaluation (adapter-backed): sklearn-regression.

    pip install 'experionyx[sklearn]'
    python examples/adapter_sklearn_regression.py [workspace]
...
if __name__ == "__main__":
    ...
    report(run_demo("sklearn-regression", workspace))
