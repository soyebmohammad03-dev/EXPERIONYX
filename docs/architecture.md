...
> **Current state:** Phase 9. Implemented: the domain model ([domain-model.md](domain-model.md)),
...
> ([faults.md](faults.md)), failure discovery and a failure registry ([failures.md](failures.md)) fault interaction analysis ([interactions.md](interactions.md)), reliability profiles ([reliability.md](reliability.md)), robustness benchmarks ([benchmarks.md](benchmarks.md)) and a CLI ([cli.md](cli.md)).
